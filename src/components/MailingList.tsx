		...
		<div className='flex flex-col gap-2 items-start relative shrink-0 w-full'>
			...
			<form onSubmit={handleSubmit} className='w-full' aria-label='Subscribe to newsletter'>
				<div className='flex items-center justify-between relative shrink-0 w-full pr-1'>
					...
					<button
						type='submit'
						className='font-medium font-mono px-4 py-1 relative shrink-0 text-olive-800 dark:text-olive-100 text-sm text-justify text-nowrap uppercase whitespace-pre hover:opacity-70 transition-opacity cursor-pointer bg-olive-300 dark:bg-olive-600 border-none disabled:opacity-40 disabled:cursor-not-allowed rounded-lg'
