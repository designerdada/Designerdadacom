    ...
    <div className="content-stretch flex gap-4 items-center relative shrink-0 w-full" role="search">
      ...
      >
        ...
        <input
          ...
          className="font-normal leading-[1.5] not-italic relative shrink-0 text-[16px] text-justify bg-transparent border-none outline-none text-[var(--foreground)] placeholder:text-slate-400 w-full"
      ...
      <div className="relative z-50" ref={dropdownRef}>
        ...
        >
          <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[var(--foreground)] text-[16px] text-justify text-nowrap whitespace-pre">
            {selectedCategory}
          </p>
          ...
          <div className="absolute right-0 top-full mt-2 bg-white dark:bg-black border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg py-1 z-50 min-w-[120px]" role="menu">
            {categories.map((category) => (
              <button
                ...
                className={`w-full text-left px-4 py-2 text-[16px] cursor-pointer transition-colors ${
                  selectedCategory === category 
  ...
  if (filteredFavorites.length === 0) {
    return (
      <div className="content-stretch flex items-center justify-center py-8 w-full">
        <p className="text-[16px] text-slate-500">No favorites found</p>
      </div>
    );
  }
        ...
        >
          <div className="basis-0 content-stretch flex gap-4 grow items-center min-h-px min-w-px relative shrink-0">
            ...
            <div className="basis-0 content-stretch flex gap-2 grow items-center min-h-px min-w-px relative shrink-0">
              <p className="font-medium leading-[1.5] not-italic relative shrink-0 text-[var(--foreground)] text-[18px] text-justify text-nowrap whitespace-pre group-hover:underline underline-offset-4">
                {favorite.name}
              </p>
              <p className="leading-[1.5] not-italic relative shrink-0 text-[14px] text-justify text-nowrap text-slate-500 whitespace-pre">
                /
              </p>
              <p className="[white-space-collapse:collapse] basis-0 grow leading-[1.5] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[var(--foreground)] text-[16px] text-justify text-nowrap">
                {favorite.description}
              </p>
            </div>
          </div>
          <p className="leading-[1.5] not-italic relative shrink-0 text-[16px] text-nowrap text-slate-500 whitespace-pre">
