  ...
  return (
    <div className="bg-[var(--background)] min-h-screen w-full flex justify-center py-10">
      <div className="flex flex-col gap-10 items-center w-full max-w-[544px] px-4 m-0">
        ...
        {/* Bio Content */}
        <div className="font-normal min-w-full relative shrink-0 text-[var(--foreground)] text-[18px] text-justify flex flex-col gap-4">
          ...
          <p className="leading-[1.5] animate-in animate-delay-4">
            ...
            >
              <button
                ...
                className="[text-underline-position:from-font] decoration-solid decoration-[var(--muted)] font-medium italic underline underline-offset-4 hover:decoration-[var(--foreground)] transition-colors cursor-pointer bg-transparent border-none p-0 text-[var(--foreground)] text-[18px]"
              >
                Say hello
              </button>
              {showTooltip && (
