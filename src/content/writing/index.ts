...
// ⚠️  DO NOT EDIT MANUALLY - Your changes will be overwritten!
// 
// To add/edit articles:
// 1. Create or edit .mdx files in /content/writing/
// 2. Run: npm run generate-mdx
// 3. Or just run: npm run dev (auto-generates)
//
// See /content/README.md for detailed instructions

// Export all MDX content as string constants
// This ensures compatibility across all build systems
